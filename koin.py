...
def main():
     ...
     for i in range(jml):
          ...
          r = requests.post("http://www.litatom.com/api/sns/v1/lit/account/deposit_by_activity?sid="+ses+"&loc=ID&uuid="+uuid+"&version=3.8.2&
lang=in&platform=android", headers=headers, data=json.dumps(data)).text
          cek = json.loads(r)
          if cek['success'] ==True:
